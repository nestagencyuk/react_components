...
# Pagination
Pagination provides a generic way to show a section of an array, useful for creating components such as pagination or sliders.
 
## Base
The most concise way of accessing the pagination state is to use the custom hook.
