    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {state !== 'Closed' && <Float portal>
            <Alert state={state} onClose={() => dispatchEvent('CLOSE')}>
    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {state !== 'Closed' && <Float portal>
            <Alert variant="Success" state={state} onClose={() => dispatchEvent('CLOSE')}>
              Wow, it worked!
            </Alert>
          </Float>}
        </Fragment>
    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {state !== 'Closed' && <Float portal>
            <Alert variant="Warning" state={state} footer={{
              actions: [
