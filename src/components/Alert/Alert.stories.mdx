    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {openState !== 'Closed' && <Float portal>
            <Alert openState={openState} onClose={() => dispatchEvent('CLOSE')}>
    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {openState !== 'Closed' && <Float portal>
            <Alert variant="Success" openState={openState} onClose={() => dispatchEvent('CLOSE')}>
              Wow, it worked!
            </Alert>
          </Float>}
        </Fragment>
    ...
    {() => {
      ...
      return (
        <Fragment>
          ...
          {openState !== 'Closed' && <Float portal>
            <Alert variant="Warning" openState={openState} footer={{
              actions: [
