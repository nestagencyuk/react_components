...
| minLength - *optional* | Minimum length of value accepted by a `text` cell | `number` |
| maxLength - *optional* | Maximum length of value accepted by a `text` cell | `number` |
| minValue - *optional* | Minimum value accepted by a `number` cell | `number` |
| maxValue - *optional* | Maximum value accepted by a `number` cell | `number` |
