...
*/ !(function() {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === i || 'number' === i) e.push(n)
                ...
                o && e.push(o)
              } else if ('object' === i) for (var l in n) r.call(n, l) && n[l] && e.push(l)
            }
          }
          return e.join(' ')
        }
    ...
    function(e, t, r) {
      ...
      t.Block = n.default
      var a = r(15)
      t.BlockHeader = a.default
      var i = r(18)
      t.BlockMedia = i.default
      var o = r(19)
      t.BlockBody = o.default
    },
    function(e, t) {
    ...
    function(e, t, r) {
      ...
      t.List = n.default
      var a = r(59)
      t.ListItem = a.default
      var i = r(60)
      t.ListLink = i.default
    },
    function(e, t, r) {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: !0 })
    ...
    function(e, t, r) {
      ...
      r.d(t, 'InView', function() {
        return g
      }),
        r.d(t, 'useInView', function() {
          return h
        })
      var s = new Map(),
        c = new Map(),
        ...
        d = 0
      function v(e, t, r) {
        void 0 === r && (r = {}), r.threshold || (r.threshold = 0)
        var n = r,
          i = n.root,
          o = n.rootMargin,
          l = n.threshold
        if ((s.has(e) && a(!1), e)) {
          var v =
              (function(e) {
                return e ? (u.has(e) ? u.get(e) : ((d += 1), u.set(e, d.toString()), u.get(e) + '_')) : ''
              })(i) + (o ? l.toString() + '_' + o : l.toString()),
            f = c.get(v)
          f || ((f = new IntersectionObserver(p, r)), v && c.set(v, f))
          var g = {
            callback: t,
            element: e,
            inView: !1,
            observerId: v,
            observer: f,
            thresholds: f.thresholds || (Array.isArray(l) ? l : [l])
          }
          return s.set(e, g), f.observe(e), g
        }
      }
      function f(e) {
        if (e) {
          ...
          if (t) {
            ...
            r &&
              s.forEach(function(t, n) {
                n !== e && (t.observerId === r && ((i = !0), (o = !0)), t.observer.root === a && (o = !0))
              }),
              !o && a && u.delete(a),
              n && !i && n.disconnect(),
              s.delete(e)
      ...
      function p(e) {
        e.forEach(function(e) {
          var t = e.isIntersecting,
            ...
            a = s.get(n)
          if (a && r >= 0) {
            var i = a.thresholds.some(function(e) {
              return a.inView ? r > e : r >= e
            })
            void 0 !== t && (i = i && t), (a.inView = i), a.callback(i, e)
          }
        })
      }
      var g = (function(e) {
        ...
        function s() {
          ...
          return (
            i(l((t = e.call.apply(e, [this].concat(n)) || this)), 'state', { inView: !1, entry: void 0 }),
            i(l(t), 'node', null),
            i(l(t), 'handleNode', function(e) {
              t.node && f(t.node), (t.node = e || null), t.observeNode()
            }),
            i(l(t), 'handleChange', function(e, r) {
              ;(e !== t.state.inView || e) && t.setState({ inView: e, entry: r }), t.props.onChange && t.props.onChange(e, r)
            }),
            t
          )
        }
        ...
        return (
          ...
          (c.componentDidUpdate = function(e, t) {
            ;(e.rootMargin === this.props.rootMargin &&
              ...
              (f(this.node), this.observeNode()),
              t.inView !== this.state.inView &&
                this.state.inView &&
                this.props.triggerOnce &&
                (f(this.node), (this.node = null))
          }),
          (c.componentWillUnmount = function() {
            this.node && (f(this.node), (this.node = null))
          }),
          (c.observeNode = function() {
            if (this.node) {
              var e = this.props,
                ...
                r = e.root,
                n = e.rootMargin
              v(this.node, this.handleChange, { threshold: t, root: r, rootMargin: n })
            }
          }),
          (c.render = function() {
            var e = this.state,
            ...
            return Object(n.createElement)(l || s || 'div', o({ ref: this.handleNode }, c), i)
          }),
          s
        )
      })(n.Component)
      function h(e) {
        ...
        var t = Object(n.useRef)(),
          r = Object(n.useState)({ inView: !1, entry: void 0 }),
          a = r[0],
          i = r[1],
              ...
              t.current && f(t.current),
                r &&
                  v(
                    r,
                    function(t, n) {
                      i({ inView: t, entry: n }), t && e.triggerOnce && f(r)
                    },
                    e
                  ),
                (t.current = r)
        ...
        return Object(n.useDebugValue)(a.inView), [o, a.inView, a.entry]
      }
      i(g, 'displayName', 'InView'), i(g, 'defaultProps', { threshold: 0, triggerOnce: !1 })
      t.default = g
    },
    function(e, t, r) {
      'use strict'
      ...
      t.Block = n.Block
      var a = r(3)
      t.BlockHeader = a.BlockHeader
      var i = r(3)
      t.BlockMedia = i.BlockMedia
      var o = r(3)
      t.BlockBody = o.BlockBody
      var l = r(20)
      t.Button = l.Button
      var s = r(23)
      t.Footer = s.Footer
      ...
      t.List = m.List
      var _ = r(5)
      t.ListItem = _.ListItem
      var w = r(5)
      t.ListLink = w.ListLink
      var b = r(2)
      t.Navigation = b.Navigation
      var y = r(2)
      t.NavigationBrand = y.NavigationBrand
      var x = r(2)
      t.NavigationList = x.NavigationList
      var M = r(2)
      t.NavigationItem = M.NavigationItem
      var O = r(2)
      t.NavigationLink = O.NavigationLink
      var N = r(78)
      t.Page = N.Page
      var j = r(82)
      t.Select = j.Select
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t,
          ...
          v = e.media,
          f = e.children,
          p = i.useInView({ threshold: 0.1, rootMargin: '100px 100px 100px 100px' }),
          g = p[0],
          h = p[1],
          m = function() {
            return v && h && a.createElement(l.BlockMedia, n({}, v))
          }
        return a.createElement(
          'section',
          { ref: g, className: o.default(c, 'block', s[u], { 'block--split': v }) },
          'Left' === (null === (t = v) || void 0 === t ? void 0 : t.align) && m(),
          d && h && a.createElement(l.BlockHeader, n({}, d)),
          f && h && a.createElement(l.BlockBody, null, f),
          'Right' === (null === (r = v) || void 0 === r ? void 0 : r.align) && m()
        )
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          'header',
          { className: a.default('block__header') },
          t && n.createElement(i.Text, { className: 'block__heading', tag: 'h1', type: 'Intro' }, t)
        )
      }
    },
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          ...
          s = 'p' !== o || r ? r : 'p',
          c = o
        return n.createElement(c, { className: a.default(t, s && s.toLowerCase()) }, l)
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return (function() {
          switch (t) {
            case 'Video':
              return n.createElement('video', { className: 'block__media', src: r })
            default:
              return n.createElement('img', { className: 'block__media', src: r, alt: a })
          }
        })()
      }
    },
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.children
        return n.createElement('div', { className: a.default('block__body') }, t)
      }
    },
    function(e, t, r) {
      'use strict'
    ...
    function(e, t, r) {
      ...
      r(22)
      var i = r(4),
        o = { Primary: 'btn--primary', Secondary: 'btn--secondary', Tertiary: 'btn--tertiary', Action: 'btn--action' }
      t.default = function(e) {
        var t = e.className,
          r = e.href,
          l = e.type,
          ...
          u = e.onClick,
          d = r ? i.Link : 'button',
          v = s ? 'submit' : r ? void 0 : 'button'
        return n.createElement(d, { className: a.default(t, 'btn', o[l]), type: v, to: r, onClick: u }, c)
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          ...
          g = e.subInfo,
          h = void 0 === g ? '' : g,
          m = i.useInView({ threshold: 0.1, rootMargin: '100px 100px 100px 100px' }),
          _ = m[0],
          w = m[1]
        return a.createElement(
          'footer',
          { ref: _, className: o.default(t, 'footer') },
          a.createElement(
            l.Grid,
            { gutter: !0 },
            a.createElement(l.GridItem, { span: 2 }, r && a.createElement(s.Image, n({ className: 'footer__img' }, r))),
            a.createElement(
              l.GridItem,
              { span: 5 },
              v.length > 0 &&
                ...
                a.createElement(
                  ...
                  v.map(function(e, t) {
                    ...
                    return a.createElement(
                      u.ListItem,
                      { key: 'item-' + t, className: 'footer__item' },
                      a.createElement(u.ListLink, { className: 'footer__link', href: n }, r)
                    )
                  })
                )
            ),
                ...
                a.createElement(
                  ...
                  p.map(function(e, t) {
                    ...
                    return a.createElement(
                      ...
                      a.createElement(
                        u.ListLink,
                        { className: 'footer__link', href: i, external: !0 },
                        a.createElement(c.Icon, { className: 'footer__icn', name: n.toLowerCase() }),
                        r
                      )
                    )
                  })
          ...
          a.createElement('div', { className: 'footer__sub' }, h)
        )
      }
    },
    function(e, t, r) {},
    ...
    function(e, t, r) {
      ...
      var n = r(0),
        ...
        o = { Top: 'grid__item--top', Bottom: 'grid__item--bottom', Center: 'grid__item--center-y' }
      t.default = function(e) {
        var t = e.className,
          r = e.span,
          l = e.align,
        ...
        return n.createElement(
          'div',
          { className: a.default(t, 'grid__item', r && 'grid__item--' + r, i[l && l.x], o[l && l.y]) },
          s
        )
      }
    },
    function(e, t, r) {
      ...
      var n = r(0),
        a = r(1)
      r(31)
      var i = { Round: 'img--round' },
        o = { Small: 'img--sm', Medium: 'img--md', Large: 'img--lg' }
      t.default = function(e) {
        var t = e.className,
          r = e.type,
          l = e.size,
          s = e.src,
          c = e.alt
        return n.createElement('img', { className: a.default(t, 'img', i[r], o[l]), src: s, alt: c })
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
      ...
      var n = r(0),
        a = r(1)
      r(33)
      var i = { XSmall: 'icn--xs', Small: 'icn--sm', Large: 'icn--lg' },
        o = { Dark: 'icn--dark', Light: 'icn--light', Success: 'icn--success', Warning: 'icn--warning', Error: 'icn--error' }
      t.default = function(e) {
        var t = e.className,
          l = e.name,
          s = e.size,
        ...
        return n.createElement('span', {
          className: a.default(t, 'icn', i[s], o[c]),
    ...
    function(e, t) {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><title>instagram</title><path d="M8,1.57c2.09,0,2.34,0,3.17,0,2.13.1,3.12,1.11,3.22,3.22,0,.83,0,1.08,0,3.17s0,2.34,0,3.17c-.1,2.11-1.09,3.12-3.22,3.22-.83,0-1.07,0-3.17,0s-2.34,0-3.17,0c-2.13-.1-3.12-1.11-3.22-3.22,0-.83,0-1.07,0-3.17s0-2.34,0-3.17c.1-2.11,1.09-3.12,3.22-3.22C5.66,1.58,5.91,1.57,8,1.57ZM8,.16c-2.13,0-2.4,0-3.23,0C1.92.33.33,1.91.2,4.77c0,.83,0,1.1,0,3.23s0,2.4,0,3.23c.13,2.85,1.71,4.44,4.57,4.57.83,0,1.1,0,3.23,0s2.4,0,3.23,0c2.85-.13,4.44-1.71,4.57-4.57,0-.83,0-1.1,0-3.23s0-2.4,0-3.23C15.67,1.92,14.09.33,11.24.2,10.4.16,10.13.16,8,.16ZM8,4a4,4,0,1,0,4,4A4,4,0,0,0,8,4Zm0,6.64A2.61,2.61,0,1,1,10.61,8,2.61,2.61,0,0,1,8,10.61Zm4.19-7.74a.94.94,0,1,0,.94.94A.94.94,0,0,0,12.19,2.87Z"></path></svg>'
    },
    function(e, t) {
      e.exports =
    ...
    function(e, t) {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><title>twitter</title><path d="M16,3a6.29,6.29,0,0,1-1.89.51,3.27,3.27,0,0,0,1.45-1.81,6.87,6.87,0,0,1-2.09.8,3.25,3.25,0,0,0-2.39-1,3.29,3.29,0,0,0-3.2,4A9.32,9.32,0,0,1,1.11,2.1a3.29,3.29,0,0,0,1,4.38A3.29,3.29,0,0,1,.64,6.07,3.3,3.3,0,0,0,3.28,9.33a3.24,3.24,0,0,1-1.49.06,3.3,3.3,0,0,0,3.07,2.28A6.63,6.63,0,0,1,0,13,9.3,9.3,0,0,0,5,14.5a9.28,9.28,0,0,0,9.33-9.76A6.79,6.79,0,0,0,16,3Z"></path></svg>'
    },
    function(e, t) {
      e.exports =
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          r = e.children
        return n.createElement('ul', { className: a.default(t, 'list') }, r)
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          r = e.children
        return n.createElement('li', { className: a.default(t, 'list__item') }, r)
      }
    },
    function(e, t, r) {
      'use strict'
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          s,
          { className: a.default(t, 'list__link'), type: 'Primary', to: r, href: r, target: o ? '_blank' : null },
          l
        )
      }
    },
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          'header',
          { className: a(t, 'header', o[r]) },
          l && n.createElement(i.Text, { tag: 'h1', type: 'Alpha' }, l),
          s && n.createElement(i.Text, { tag: 'h2', type: 'Beta' }, s),
          c
        )
      }
    },
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          r = e.for,
          i = e.children
        return n.createElement('label', { className: a.default(t, 'label'), htmlFor: r }, i)
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
    ...
    function(e, t, r) {
      ...
      r(71)
      var i = r(4),
        o = { Primary: 'link--primary', Secondary: 'link--secondary', Tertiary: 'link--tertiary' }
      t.default = function(e) {
        var t = e.className,
          r = e.type,
          l = e.href,
          s = e.children
        return n.createElement(i.Link, { className: a.default(t, 'link', o[r]), to: l }, s)
      }
    },
    function(e, t, r) {},
    function(e, t, r) {
      ...
      t.default = function(e) {
              ...
              a.createElement(
                ...
                e.map(function(e) {
                  return a.createElement(
                    ...
                    a.createElement(o.NavigationLink, n({}, e), e.text)
                  )
                })
              )
            )
        ...
        return a.createElement(
          'nav',
          { className: i.default(t, 'nav', l[u.align]), style: r },
          h && a.createElement(o.NavigationBrand, n({}, u)),
          _ && a.createElement(s, null),
          w(p, 'Start'),
          m && a.createElement(o.NavigationBrand, n({}, u)),
          w(g, 'End'),
          _ && a.createElement(o.NavigationBrand, n({}, u)),
          (h || m) && a.createElement(s, null),
          f
        )
      }
    },
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          i.Link,
          { className: a.default(t, 'nav__brand'), to: s },
          n.createElement('img', { className: a.default('nav__img'), src: o.src })
        )
      }
    },
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          r = e.align,
          o = e.children
        return n.createElement('ul', { className: a.default(t, 'nav__list', i[r]) }, o)
      }
    },
    function(e, t, r) {
      'use strict'
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        var t = e.className,
          ...
          c = e.onClick,
          u = r || i.Link
        return n.createElement(u, { className: a.default(t, 'nav__link', { 'nav__link--active': l }), to: o, onClick: c }, s)
      }
    },
    function(e, t, r) {
      'use strict'
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          a.Fragment,
          null,
          n.createElement(l, { config: i.excludeFromObj(t, ['view', 'content']), content: t.content, data: r }),
          o
        )
      }
    },
      ...
      t.default = function(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement('option', { value: '', disabled: !0 }, o),
            s.map(function(e) {
              return n.createElement('option', null, e.label)
            })
          ),
    ...
    function(e, t, r) {
      ...
      t.default = function(e) {
        ...
        return n.createElement('textarea', {
          className: a.default(t, 'textarea'),
          value: r || '',
          rows: 6,
          onChange: function(e) {
